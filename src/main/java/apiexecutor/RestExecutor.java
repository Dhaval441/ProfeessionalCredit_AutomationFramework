...
public class RestExecutor {
	...
	/**
	 * Executes GET request with Auth token and returns response JSON.
	 * 
	 * @param path
	 * @param Access
	 *            Token , Content Type
	...
	/**
	 * This is used to set add Authorization header with Basic client credential
	...
	/**
	 * Executes Patch/Update request and returns response JSON.
	 * 
	 * @param path
	 * @param headers
	 * @param xmlContent
	...
	/**
	 * Executes PUT request with env-id flag and returns response JSON.
	 * 
	 * @author Malay.Shah
	 * @param path
	 * @param headers
	...
	/**
	 * Executes Patch/Update request with Env-id flag and returns response JSON.
	 * 
	 * @author Malay.Shah
	 * @param path
	 * @param headers
